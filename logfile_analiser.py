...
class logfile_analiser():
    ...
    def parseLogfile1a(self):
        ...
        for OrderBookID in OrderBookIDs:
            print '-'*40, 'Session 1 - Test case 1: Interpretation of Reference Data', '-'*40
    ...
    def parseLogfile1b(self):
        ...
        total_count = 8
        for OrderBookID in OrderBookIDs:
            print '-'*40, 'Session 1 - Test case 1: Ref Data (Next Day Effective Series)', '-'*40
            inputFile = open(logfile, 'r')
            found = False
            count = 0
            in_file = False
            for line in inputFile.readlines():
                if 'Contract Created' in line or '_DEFINITIONS' in line:
                    if '%s]' % OrderBookID in line and 'HSI15000R9' in line:
                        count = 0
                        found = True
                if found:
    ...
    def parseLogfile2a(self):

        obID_mkts = [['0', '16'], ['0', '35'], ['0', '38'], ['1118114', '0']]

        logfile = self.optmenu()

        for obID_mkt in obID_mkts:
            print '-'*40, 'Session 1 - Test case 2: Sec. A Interpretation of Status Data: Market Status', '-'*40
            inputFile = open(logfile, 'r')
            in_file = False
            for line in inputFile.readlines():
                if all(obID_mkt_values in line for obID_mkt_values in obID_mkt):
                    if 'HandleMarketStatus' in line and 'obId:%s' % obID_mkt in line:
                        print line
                        in_file = True
                    elif 'Market Status Received' in line and 'o:%s' % obID_mkt in line:
                        print line
                        in_file = True
            ...
            if not in_file:
                print 'OrderBookID %s Not Found!' % obID_mkt

            inputFile.close()

    def parseLogfile2b(self):

        obID_seqs = [['1118114', '6730'], ['1118114', '6731'], ['266148', '6827'], ['0', '6841'], ['266148', '7220'], ['266148', '7228'], ['0', '6996'], ['0', '6635'], ['0', '7362'], ['790434', '8058']]

        logfile = self.optmenu()

        for obID_seq in obID_seqs:
            print '-'*40, 'Session 1 - Test case 2: Sec. B Interpretation of Status Data: Market Status', '-'*40
            inputFile = open(logfile, 'r')
            in_file = False
            for line in inputFile.readlines():
                if all(obID_seq_values in line for obID_seq_values in obID_seq):
                    if 'HandleMarketStatus' in line and 'obId:%s' % obID_seq in line:
                        print line
                        in_file = True
                    elif 'Market Status Received' in line and 's:%s' % obID_seq in line:
                        print line
                        in_file = True
                    elif 'msgType320' in line:
                        print line
            ...
            if not in_file:
                print 'OrderBookID %s Not Found!' % obID_seq
...
#                 print 'OrderBookID %s Not Found!' % OrderBookID
    ...
    def parseLogfile3(self):
        ...
        for OrderBookID in OrderBookIDs:
            print '-'*40, 'Session 1 - Test case 3: Interpretation of Status Data: Series Status', '-'*40
            inputFile = open(logfile, 'r')
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile04(self):
        ...
        for OrderBookID in OrderBookIDs:
            print '-'*40, 'Session 1 - Test case 4: Interpretation of Status Data: Commodity Status', '-'*40
            inputFile = open(logfile, 'r')
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile05(self):
        ...
        for OrderBookID in OrderBookIDs:
            print '-'*40, 'Session 1 - Test case 5: Interpretation of Order Book Data: Quote Request', '-'*40
            inputFile = open(logfile, 'r')
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile08(self):
        ...
        for obID_prc in obID_prcs:
            print '-'*40, 'Session 1 - Test case 8: Interpretation of Trade and Price Data : Calculated Opening Price', '-'*40
            inputFile = open(logfile, 'r')
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile10(self):
        ...
        for alert in alerts:
            print '-'*40, 'Session 1 - Test case 10: Interpretation of News : Market Alert', '-'*40
            inputFile = open(logfile, 'r')
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16a(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 1 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16b(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 2 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16bc(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 3 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16d(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 4 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16e(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 5 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16f(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 6 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16g(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 7 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16h(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 8 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16i(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 9 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16j(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 10 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16k(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 11 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16l(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 12 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16m(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 13 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16n(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 14 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16o(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 15 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile16p(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 16: Scenario 16 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile17a(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 17: Scenario 1 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile17b(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 17: Scenario 2 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile17c(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 17: Scenario 3 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile17d(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 17: Scenario 4 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile17e(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 17: Scenario 5 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
    ...
    def parseLogfile17f(self):
        ...
        for TradeID in TradeIDs:
            print '-'*40, 'Session 1 - Test Case 17: Scenario 6 Interpretation of Trade and Trade Amendment', '-'*40
            inputFile = open(logfile, 'r')
            # found = False
            in_file = False
            for line in inputFile.readlines():
